...
const GENRE_SEO = {
  ...
  'kids': {
    h2: 'הצגות ילדים: חוויה שהמשפחה כולה תזכור',
    lead: 'אורות, מחיאות כפיים, והילדים שלך מרותקים מהרגע הראשון. ריכזנו את מיטב הצגות הילדים והמשפחה בכל רחבי הארץ.',
    points: [['לכל גיל:', 'מהצגות פעוטות אינטראקטיביות ועד הרפתקאות לכל המשפחה בחגים ובחופשות.'], ['בלי כאב ראש:', 'רכישה מאובטחת, מקומות טובים לילדים וכרטיסים שמגיעים ישר למייל.']],
    cta: 'המופעים לחופשות נחטפים מהר. בחר את ההצגה ותפוס מקום למשפחה.',
  },
  'classical': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera', 'classical']);
