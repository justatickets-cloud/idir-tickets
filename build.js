...
const GENRE_SEO = {
  ...
  'classical': {
    h2: 'מוזיקה קלאסית וקונצרטים: רגעים של יופי צרוף',
    lead: 'תזמורת מלאה, אקוסטיקה מושלמת, וצמרמורת שרק מוזיקה חיה יודעת להעניק. ריכזנו את הקונצרטים הקלאסיים המובילים בישראל.',
    points: [['מהיצירות הגדולות:', 'סימפוניות, רסיטלים לפסנתר, מוזיקה קאמרית וקונצרטים לאור נרות.'], ['שקט נפשי מלא:', 'רכישה מאובטחת, בחירת מקומות מדויקת וכרטיסים דיגיטליים ישר למייל.']],
    cta: 'השורות הטובות באולם אוזלות ראשונות. בחר את הקונצרט שלך ותפוס מקום.',
  },
  'jazz-blues': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera']);
