...
const GENRE_SEO = {
  ...
  'standup': {
    ...
    lead: `צריכים קצת בריחה מהשגרה? ריכזנו עבורכם את הקומיקאים הכי מצחיקים בארץ לערב אחד שכולו בידור נטו, מסטנדאפ פוליטי ועד הומור אבסורדי וערבי אימפרוב.`,
    points: [[`מצאו הופעות לפי תאריך:`, `מצאו הופעות להיום, למחר, לסוף השבוע, לחודש הקרוב, או לכל שנת 2026 ו-2027, לפי ז'אנר, עיר או שם האולם.`], [`בלי כאב ראש:`, `רכישה מאובטחת לחלוטין, בחירת מקומות מעולים, וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל.`]],
    cta: `הכרטיסים למופעי הסטנדאפ המבוקשים נחטפים בקצב שיא, גללו למטה, בחרו את המופע שלכם ותפסו מקום לפני שייגמר!`,
  },
  'dance-ballet': {
