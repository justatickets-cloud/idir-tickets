...
const GENRE_SEO = {
  ...
  'jazz-blues': {
    h2: 'ג' + "'" + 'אז ובלוז: הלילות הכי מסוגננים בעיר',
    lead: 'אורות עמומים, כלי נשיפה, ואלתור שקורה כאן ועכשיו. מיטב מופעי הג' + "'" + 'אז והבלוז בישראל מחכים לך.',
    points: [['מהמועדונים הטובים:', 'שבלול, במות הג' + "'" + 'אז המובילות ופסטיבלים ייחודיים לאורך השנה.'], ['קל ומאובטח:', 'בחר ערב, בחר מקום, והכרטיסים אצלך תוך דקה.']],
    cta: 'המועדונים האינטימיים מתמלאים מהר. בחר את המופע ותפוס מקום.',
  },
  'standup': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera', 'classical', 'kids', 'plays']);
