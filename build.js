...
const GENRE_SEO = {
  ...
  'opera': {
    h2: 'אופרה: הדרמה הגדולה של המוזיקה',
    lead: 'קולות ענק, תזמורת מלאה, וסיפורים על אהבה וגורל שמרגשים כבר מאות שנים. מיטב הפקות האופרה בישראל מחכות לך.',
    points: [['מהיצירות הנצחיות:', 'ורדי, פוצ' + "'" + 'יני, מוצרט והפקות עכשוויות נועזות.'], ['שקט נפשי מלא:', 'רכישה מאובטחת, בחירת מקומות מדויקת וכרטיסים דיגיטליים.']],
    cta: 'המקומות הטובים באולם נחטפים. בחר את ההפקה ותפוס מקום.',
  },
  'rock': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows']);
