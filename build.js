...
const GENRE_SEO = {
  ...
  'musical': {
    h2: 'מחזמר: הפקות ראווה עם שירים שנשארים איתך',
    lead: 'תזמורת חיה, תפאורה מרהיבה, ושירים שתמצא את עצמך מזמזם ימים אחרי. מיטב המחזות הזמר בישראל כאן.',
    points: [['מההפקות הגדולות:', 'קלאסיקות ברודוויי, מחזות זמר ישראליים מקוריים והפקות משפחה.'], ['שקט נפשי מלא:', 'רכישה מאובטחת, בחירת מקומות וכרטיסים דיגיטליים ישר למייל.']],
    cta: 'ההצגות המבוקשות מתמלאות שבועות מראש. בחר את המחזמר שלך ותפוס מקום.',
  },
  'opera': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera', 'classical', 'kids', 'plays', 'jazz-blues']);
