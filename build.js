...
const GENRE_SEO = {
  'shows': {
    ...
    lead: `אין תחליף לאנרגיה של קהל חי ולרגע הזה שבו האורות באולם נכבים. ריכזנו עבורך את כל ההופעות השוות ביותר בישראל, ממופעי ענק בהיכלים ועד לבמות החיות האינטימיות ביותר.`,
    points: [
