...
const GENRE_SEO = {
  ...
  'standup': {
    h2: 'סטנד אפ ובידור: ערב שכולו צחוק',
    lead: 'הקומיקאים הכי מצחיקים בישראל, חומר חדש, וערב שישאיר לך כאב בטן מרוב צחוק. ריכזנו את מיטב מופעי הסטנד אפ בארץ.',
    points: [['מכל הסגנונות:', 'סטנד אפ פוליטי, הומור אבסורדי, מופעי יחיד וערבי אימפרוב.'], ['בלי כאב ראש:', 'רכישה מאובטחת, מקומות טובים וכרטיסים שמגיעים ישר למייל.']],
    cta: 'מופעי היחיד המבוקשים נחטפים. בחר את המופע שלך ותפוס מקום.',
  },
  'dance-ballet': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet']);
