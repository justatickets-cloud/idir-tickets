...
const GENRE_SEO = {
  'shows': {
    h2: 'הופעות חיות בישראל: המוזיקה הכי טובה, כרטיסים במקום אחד',
    lead: 'הזמר האהוב עליך עולה לבמה, ואתה לא רוצה לפספס. ב-iDir ריכזנו את מיטב ההופעות החיות בישראל, מההיכלות הגדולים ועד המועדונים האינטימיים.',
    points: [['כל הסגנונות:', 'פופ ישראלי, רוק, ים תיכוני, מוזיקה אתנית ואמנים בינלאומיים בסיבובי הופעות.'], ['שקט נפשי מלא:', 'רכישה מאובטחת, בחירת מקומות מדויקת וכרטיסים דיגיטליים שמגיעים ישר אליך למייל.']],
    cta: 'המקומות הטובים אוזלים ראשונים. גלול למטה, בחר את ההופעה שלך ותפוס מקום.',
  },
  'plays': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup']);
