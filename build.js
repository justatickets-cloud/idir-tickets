...
const GENRE_SEO = {
  ...
  'plays': {
    h2: 'הצגות תיאטרון: הרגעים הגדולים של הבמה הישראלית',
    lead: 'מהדרמה שתשאיר אותך בלי מילים ועד הקומדיה שתגרום לך לצחוק עד דמעות, התיאטרון הישראלי במיטבו נמצא כאן.',
    points: [['מכל התיאטראות:', 'הבימה, הקאמרי, בית ליסין, גשר ותיאטראות הפרינג' + "'" + ' הקטנים.'], ['קל ומהיר:', 'בחר תאריך, אולם ומקומות, והכרטיסים אצלך תוך דקה.']],
    cta: 'ההצגות המבוקשות מתמלאות מראש. בחר את ההצגה שלך עכשיו ותפוס מקום.',
  },
  'kids': {
...
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera', 'classical', 'kids']);
