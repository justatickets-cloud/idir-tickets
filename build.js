...
/* ---- תוכן SEO ייחודי לכל עמוד ז'אנר (Direct-Response) ---- */
// מפתח: slug מתוך CATEGORY_SLUGS. כל ערך: כותרת H2, פסקת פתיחה, נקודות מודגשות, וקריאה לפעולה.
// אם אין ערך לז'אנר מסוים, לא מוצג כלום (fallback שקט, לא שובר בנייה).
const GENRE_SEO = {
  'shows': {
    h2: `הופעות חיות ואירועים חמים: הבמה של ישראל פתוחה לפניך`,
    lead: `אין תחליף לאנרגיה של קהל חי ולרגע הזה שבו האורות באולם נכבים. ריכזנו עבורכם את כל ההופעות השוות ביותר בישראל, ממופעי ענק בהיכלים ועד לבמות החיות האינטימיות ביותר.`,
    points: [
      [`מצאו הופעות לפי תאריך:`, `מצאו הופעות להיום, למחר, לסוף השבוע, לחודש הקרוב, או לכל שנת 2026 ו-2027, לפי ז'אנר, עיר או שם האולם.`],
      [`חוויה בלי מאמץ:`, `בחרו את האמן, סננו לפי העיר או האולם המועדף עליכם, וקבלו את הכרטיס הדיגיטלי ישר למייל תוך שנייה.`],
    ],
  },
  'plays': {
    h2: `קסם התיאטרון הישראלי: מיטב ההצגות והשחקנים על במה אחת`,
    lead: `לצאת מהשגרה, לשקוע בעלילה מרתקת ולחוות את השחקנים הגדולים בישראל מקרוב. במקום לקפוץ בין אתרי קופות שונים, ריכזנו עבורכם את כל ההצגות החמות של עולם התיאטרון במקום אחד ובאפס מאמץ.`,
    points: [
      [`מהקלאסיקות ועד לקומדיות ודרמות בועטות:`, `רפרטואר עשיר המציג את מיטב הכישרונות באולמות ובבתי התיאטרון המובילים בישראל: התיאטרון הלאומי הבימה, הקאמרי, בית ליסין, תיאטרון אורנה פורת, תמונע וצוותא.`],
      [`אפס מאמץ, שקט נפשי מלא:`, `רכישה קלה ומאובטחת, בחירת המקומות הטובים ביותר באולם וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל.`],
    ],
    cta: `הכרטיסים לשורות המרכזיות ולתאריכים המבוקשים נחטפים מהר. גללו למטה, בחרו את ההצגה הבאה שלכם ותפסו מקום עכשיו!`,
  },
  'kids': {
    h2: `יוצרים זיכרונות עם הילדים: מיטב ההצגות ומופעי הילדים בישראל במקום אחד`,
    lead: `מחפשים את הבילוי המשפחתי המושלם לחופשה הקרובה או לשבת בבוקר? במקום לשבור את הראש בחיפושים, ריכזנו עבורכם את כל מה שהילדים (וגם אתם) באמת אוהבים לראות, קרוב לבית ובלי להתאמץ.`,
    points: [
      [`מגיבורי הילדים ועד לקלאסיקות העל-זמניות:`, `הפקות ענק לחגים כמו חנוכה וסוכות, וספרי הילדות שקמים לתחייה על הבמה: סינדרלה, פינוקיו, אליסה בארץ הפלאות, טרזן, רובינזון קרוזו, בן המלך והעני, הלב ובגדי המלך החדשים. כל זאת לצד ההצגות האהובות כמו "הבית של יעל" ומופעי כוכבים כמו מיקי ו"הקרנבל של יובל".`],
      [`אפס מאמץ, שקט נפשי להורים:`, `רכישה קלה ומאובטחת, בחירת מקומות מהירה וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל בראש שקט.`],
    ],
    cta: `הכרטיסים למופעי החגים ולהצגות המבוקשות נחטפים הכי מהר. גללו למטה, בחרו את ההצגה הבאה שלכם ותפסו מקומות מעולים לכל המשפחה!`,
  },
  'classical': {
    h2: `חוויה של צליל, רגש והרמוניה: מיטב הקונצרטים והמוזיקה הקלאסית בישראל`,
    lead: `לחובבי המוזיקה שמחפשים את השילוב המושלם בין וירטואוזיות לאקוסטיקה מופלאה. אנחנו מרכזים עבורכם את מיטב הקונצרטים, הרסיטלים והתזמורות, כדי שתוכלו ליהנות מהיצירות הגדולות ביותר מבלי להשקיע מאמץ בחיפוש כרטיסים.`,
    points: [
      [`מבאך, דרך מוצרט ועד בטהובן:`, `ביצועים חיים ליצירות המופת של כל הזמנים: תזמורות פילהרמוניות, הרכבים קאמריים, סולנים מהארץ ומחו"ל וקונצרטים קסומים באווירה מיוחדת.`],
      [`אפס מאמץ, שקט נפשי מלא:`, `רכישה מהירה ומאובטחת, בחירת מקומות נוחה וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל.`],
    ],
    cta: `הכרטיסים לאזורי הישיבה בעלי האקוסטיקה הטובה ביותר באולם נחטפים במהירות. גללו למטה, בחרו את הקונצרט הבא שלכם ותפסו מקום עכשיו!`,
  },
  'jazz-blues': {
    h2: `מקצב, נשמה ובלו נוטס: מיטב מופעי הג'אז והבלוז בישראל`,
    lead: `לחובבי האלתור החופשי, הסווינג הלוהט וזעקת הבלוז החודרת. במקום לשבור את הראש בחיפושים אחרי הליין-אפ המושלם, ריכזנו עבורכם את כל הקסם, מהמועדונים האינטימיים והאפלוליים ועד לבמות הפסטיבלים הגדולות, כדי שתוכלו לתת לנפש שלכם את הגרוב המדויק.`,
    points: [
      [`ממועדוני ניו אורלינס ושיקגו ועד לשדרות בפריז:`, `רפרטואר עשיר שמחזיר לחיים את אגדות המוזיקה. ממחוות ענק לדיוות כמו אלה פיצג'רלד ונינה סימון, דרך מופעי ביג בנד וסווינג של שנות ה-30, ג'אז צועני וירטואוזי ועד לשיקגו בלוז שורשי מחוספס ומקצבים קובניים של הבואנה ויסטה.`],
      [`אפס מאמץ, שקט נפשי מלא:`, `רכישה מאובטחת ומהירה, בחירת המקומות המדויקים באולם (כדי שלא תפספסו אף פריטה על הקונטרבס או סולו סקסופון), וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל.`],
    ],
    cta: `הכרטיסים למופעי הפרימיום ולשולחנות הטובים במועדונים נחטפים במהירות. גללו למטה, תפסו את המקומות שלכם וצאו למסע מוזיקלי בלתי נשכח!`,
  },
  'standup': {
    h2: `ערב שישאיר אתכם עם כאב בטן מרוב צחוק: כל מופעי הסטנדאפ בישראל`,
    lead: `צריכים בריחה מהשגרה? ריכזנו את הקומיקאים הכי מצחיקים בארץ לערב אחד שכולו בידור, מסטנדאפ פוליטי ועד הומור אבסורדי וערבי אימפרוב. אתם באים לצחוק, אנחנו דואגים לכל השאר.`,
    points: [
      [`מצאו הופעה בשניות:`, `הופעות להיום, למחר, לסוף השבוע או לכל שנת 2026 ו-2027, לפי ז'אנר, עיר או אולם. הכל במקום אחד, בלי לרוץ בין אתרים.`],
      [`קנייה בראש שקט:`, `רכישה מאובטחת לחלוטין, כרטיסים רשמיים ובחירת מקומות מדויקת. הכרטיס הדיגיטלי מגיע ישר למייל תוך דקה.`],
      [`המקומות הטובים אוזלים ראשונים:`, `המופעים המבוקשים נמכרים מהר, והשורות הקדמיות נחטפות לפני כולם.`],
    ],
    cta: `בחרו את המופע שלכם עכשיו ותפסו מקום לפני שנגמר. גללו למטה והכרטיסים אצלכם.`,
  },
  'dance-ballet': {
    h2: 'עולם המחול והבלט: הופעות קסומות, כרטיסים מובטחים',
    lead: 'המחזה המרהיב הבא עולה על הבמה, ואתה חייב להיות שם. ב-iDir ריכזנו עבורך את מיטב הופעות המחול, הבלט הקלאסי, הפלמנקו והיצירות העכשוויות המובילות בישראל.',
    points: [['הפקות ענק מכל העולם:', 'מסינדרלה ואגם הברבורים ועד בכורות עולמיות ופסטיבלים בינלאומיים.'], ['שקט נפשי מלא:', 'רכישה מאובטחת, בחירת מקומות מדויקת וכרטיסים דיגיטליים שמגיעים ישר אליך למייל.']],
    cta: 'הכרטיסים לשורות הטובות ביותר נגמרים מהר. גלול למטה, בחר את המופע שלך ותפוס מקום.',
  },
  'musical': {
    h2: `קסם הבמה והשואו הענק: מחזות הזמר הגדולים בישראל`,
    lead: `בין אם הלב שלכם פועם בקצב של ברודוויי או מתרגש מהפקות ענק של הווסט אנד בלונדון, כבר לא צריך לטוס רחוק. אספנו עבורכם את מיטב מחזות הזמר וההפקות המוזיקליות הנוצצות ביותר בארץ, כי כשהמסך עולה והתזמורת מתחילה לנגן, הקסם קורה כאן ועכשיו.`,
    points: [
      [`מיצירות מופת עולמיות ועד קלאסיקות ישראליות:`, `הפקות ענק עוצרות נשימה כמו "קברט", "סיפור הפרברים", "היומן" ו"כנר על הגג", לצד הלהיטים של התיאטרון המקומי, מ"קזבלן" ו"החבדניקים" ועד לסיפורי החיים המרגשים של שושנה דמארי ועופרה חזה.`],
      [`אפס מאמץ, שקט נפשי מלא:`, `רכישה קלה ומאובטחת, בחירת המקומות הכי טובים באולם כדי שלא תפספסו אף תלבושת או קטע ריקוד, וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל.`],
    ],
    cta: `הכרטיסים לשורות המרכזיות בהפקות הענק נחטפים הכי מהר. גללו למטה, בחרו את המחזמר הבא שלכם ותפסו מקום לערב של שואו בלתי נשכח!`,
  },
  'opera': {
    h2: `ערב של קלאסיקה ועוצמה קולית: מיטב מופעי האופרה בישראל במקום אחד`,
    lead: `אין תחליף לעוצמה של קול אנושי חי על הבמה, לתפאורה המושקעת ולרגש ששוטף את האולם. ריכזנו עבורכם את הפקות האופרה הגדולות, קונצרטים קוליים ורסיטלים של מיטב הסולנים והתזמורות מהארץ ומהעולם.`,
    points: [
      [`יצירות מופת והפקות ענק:`, `מ"לה טרוויאטה" ו"קוולריה רוסטיקנה", דרך אריות מפורסמות ועד נשפי אופרה חגיגיים לאור נרות.`],
      [`שקט נפשי מלא:`, `רכישה מאובטחת לחלוטין, בחירת מקומות ישיבה אופטימלית וכרטיסים דיגיטליים שמגיעים ישר אליכם למייל ללא מאמץ.`],
    ],
    cta: `הכרטיסים לאזורי הישיבה הטובים והאקוסטיים ביותר באולם נחטפים במהירות. גללו למטה, בחרו את המופע שלכם ותפסו מקום עכשיו!`,
  },
  'rock': {
    h2: 'הופעות רוק: הווליום עולה, האנרגיה מתפוצצת',
    lead: 'גיטרות, בס שמרעיד את החזה, וקהל ששר כל מילה. מיטב הופעות הרוק בישראל, מקומיות ובינלאומיות.',
    points: [['מכל הגלים:', 'רוק ישראלי קלאסי, אינדי, מטאל וטריביוטים ללהקות אגדיות.'], ['קל ומאובטח:', 'בחר הופעה, בחר מקום, והכרטיסים אצלך תוך דקה.']],
    cta: 'ההופעות הגדולות אוזלות מהר. בחר את ההופעה ותפוס מקום.',
  },
  'lectures': {
    h2: 'הרצאות וכיתות אמן: ללמוד, להתרגש, להעשיר',
    lead: 'שעה במחיצת מי שבאמת יודע, עם תובנות שנשארות איתך הרבה אחרי. מיטב ההרצאות וכיתות האמן בישראל.',
    points: [['ממגוון תחומים:', 'תרבות, מדע, אמנות, היסטוריה ומפגשים עם יוצרים מובילים.'], ['קל ומהיר:', 'בחר מפגש, בחר מקום, והכרטיסים אצלך תוך דקה.']],
    cta: 'המפגשים האינטימיים מתמלאים מהר. בחר את ההרצאה ותפוס מקום.',
  },
  'exhibitions': {
    h2: 'תערוכות: אמנות וחוויה שמדברות אליך',
    lead: 'יצירות שגורמות לעצור, להסתכל, ולחשוב. ריכזנו את התערוכות והחוויות המובילות בישראל.',
    points: [['ממגוון עולמות:', 'אמנות עכשווית, תערוכות חווייתיות ומיצגים לכל המשפחה.'], ['קל ומאובטח:', 'בחר תאריך, הזמן כרטיסים, והכל אצלך תוך דקה.']],
    cta: 'לתערוכות המבוקשות כדאי להקדים. בחר את החוויה ותפוס מקום.',
  },
  'kids-concerts': {
    h2: 'קונצרטים לילדים: המפגש הראשון עם מוזיקה חיה',
    lead: 'עיניים נוצצות, אוזניים קשובות, וילדים שמגלים בפעם הראשונה את הקסם של תזמורת חיה. ריכזנו את מיטב הקונצרטים לילדים.',
    points: [['מותאם לגיל:', 'קונצרטים אינטראקטיביים, סיפור ומוזיקה, וחוויות לכל המשפחה.'], ['בלי כאב ראש:', 'רכישה מאובטחת, מקומות טובים וכרטיסים שמגיעים ישר למייל.']],
    cta: 'המופעים לחופשות נחטפים מהר. בחר את הקונצרט ותפוס מקום למשפחה.',
  },
  'story-time': {
    h2: 'שעת סיפור: רגע קסום לקטנטנים',
    lead: 'סיפור שמתעורר לחיים, דמויות אהובות, וקהל קטן עם עיניים גדולות. ריכזנו את מיטב מופעי שעת הסיפור לגיל הרך.',
    points: [['מותאם לקטנטנים:', 'מופעים אינטראקטיביים, שירים ותנועה בסביבה חמה ובטוחה.'], ['בלי כאב ראש:', 'רכישה מאובטחת, מקומות טובים וכרטיסים שמגיעים ישר למייל.']],
    cta: 'המופעים הקטנים מתמלאים מהר. בחר את שעת הסיפור ותפוס מקום.',
  },
  'circus': {
    h2: 'קרקס: להטוטים, מעוף, וקהל שעוצר נשימה',
    lead: 'אקרובטים באוויר, צבע, ומופע שגורם לכל המשפחה לפעור פה. ריכזנו את מיטב מופעי הקרקס בישראל.',
    points: [['לכל המשפחה:', 'קרקס עכשווי, מופעי אוויר וחוויות ראווה מסביב לעולם.'], ['בלי כאב ראש:', 'רכישה מאובטחת, מקומות טובים וכרטיסים שמגיעים ישר למייל.']],
    cta: 'המופעים לחופשות נחטפים מהר. בחר את המופע ותפוס מקום למשפחה.',
  },
  'attractions': {
    h2: 'אטרקציות: חוויות שיוצאות מהשגרה',
    lead: 'יום שלם של כיף, חוויות שלא תשכח, ורגעים שמצטלמים מעצמם. ריכזנו את מיטב האטרקציות והחוויות בישראל.',
    points: [['לכל הגילים:', 'חוויות משפחתיות, אטרקציות עונתיות ואירועים ייחודיים.'], ['קל ומאובטח:', 'בחר תאריך, הזמן כרטיסים, והכל אצלך תוך דקה.']],
    cta: 'לאטרקציות המבוקשות כדאי להקדים. בחר את החוויה ותפוס מקום.',
  },
  'movies': {
    h2: 'סרטים ומופעי מסך: הקולנוע בגדול',
    lead: 'המסך הגדול, האווירה, והרגע שהאורות כבים. ריכזנו את ההקרנות והמופעים המיוחדים על המסך בישראל.',
    points: [['ממגוון סוגות:', 'הקרנות מיוחדות, בכורות ואירועי מסך ייחודיים.'], ['קל ומהיר:', 'בחר הקרנה, בחר מקום, והכרטיסים אצלך תוך דקה.']],
    cta: 'להקרנות המיוחדות כדאי להקדים. בחר את הסרט ותפוס מקום.',
  },
};

// כרגע מפעילים את בלוק ה-SEO רק בז'אנרים שברשימה. להוסיף slug כדי לפרסם עוד ז'אנר.
const GENRE_SEO_ENABLED = new Set(['dance-ballet', 'standup', 'shows', 'opera', 'classical', 'kids', 'plays', 'jazz-blues', 'musical']);
function genreSeoBlock(slug) {
  if (!GENRE_SEO_ENABLED.has(slug)) return ''; // ז'אנר שעדיין לא הופעל
  const c = GENRE_SEO[slug];
  if (!c) return ''; // fallback שקט: אין תוכן ייחודי -> לא מציגים כלום
...
function hanukkah2026Article(shows) {
  ...
  const bodyHtml = `<p class="mag-lead">חג החנוכה מתקרב, ואיתו האתגר השנתי שכל הורה מכיר: איך לייצר לילדים חוויות בלתי נשכחות, איכותיות, ובלי לבזבז שעות על חיפושים? עשינו את העבודה הקשה בשבילכם. סיננו, בחרנו וריכזנו במקום אחד את הפקות הענק, מחזות הזמר והצגות הילדים המושקעות ביותר של חנוכה 2026.</p>
<p>במקום לקפוץ בין עשרות אתרים מבלבלים, כאן תמצאו את כל ההופעות פרוסות בצורה ברורה, לפי תאריכים, ערים ואולמות בכל רחבי הארץ. עם רכישה מאובטחת, אפס תקלות, וכרטיסים דיגיטליים שמגיעים ישירות אליכם לנייד, מעולם לא היה קל יותר לארגן את הבילוי המשפחתי.</p>
<p><strong>שימו לב:</strong> מניסיון של שנים, המקומות השווים באולמות המרכזיים ובשעות הנוחות ביותר (הצגות הבוקר ואחר הצהריים) אוזלים כבר במהלך נובמבר. אל תחכו לרגע האחרון שבו יישארו רק מושבים בקצוות האולם.</p>
<p>גללו מטה, בחרו את ההצגה המושלמת עבור הילדים שלכם, שריינו עכשיו את המושבים הטובים ביותר, ותבטיחו לעצמכם חנוכה מלא בקסם, שקט נפשי, וזמן איכות משפחתי אמיתי.</p>
${grid}`;
  return {
    slug: 'הצגות-חנוכה-2026',
    title: 'מופעי חנוכה 2026: המדריך המלא להצגות הילדים המובילות בישראל',
    description: 'המדריך המלא להצגות ומופעי חנוכה 2026 לילדים בישראל: הפקות ענק, מחזות זמר והצגות ילדים לפי תאריכים, ערים ואולמות, עם רכישה מאובטחת והזמנת כרטיסים במקום אחד.',
...
<main class="wrap main">
  <button type="button" id="filters-toggle" class="filters-toggle" aria-expanded="false" aria-controls="filters-panel"><span>סינון: קטגוריה, עיר, תאריך ואולם</span><span id="filters-count" class="filters-count" aria-label="מספר מסננים פעילים" hidden></span></button>
  <div class="filters" id="filters-panel">
    ...
    <button type="button" id="filters-done" class="btn btn-primary filters-done">הצג תוצאות</button>
  </div>
...
(function(){
  ...
  function sync(){
    ...
    badge.hidden=!n;
    if(done&&countEl) done.textContent='הצג '+countEl.textContent;
  }
