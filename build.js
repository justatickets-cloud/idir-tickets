...
const GENRE_SEO = {
  ...
  'kids': {
    ...
    points: [
      [`מכוכבי הילדים ועד קלאסיקות אהובות:`, `הפקות ענק מרהיבות לחגים כמו חנוכה וסוכות, פסטיבלים מושקעים, וסיפורי הילדים המוכרים שכולנו גדלנו עליהם שקמים לתחייה על הבמה.`],
